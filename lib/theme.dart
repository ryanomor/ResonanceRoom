...
/// Vibrant & Energetic color palette for social gaming app
class LightModeColors {
  ...
  static const lightSecondary = Color(0xFF9333EA);
  ...
  // Surface and background: Clean white with subtle variants
...
class DarkModeColors {
  ...
  static const darkPrimary = Color(0xFF5B8EFF);
  static const darkOnPrimary = Color(0xFF001A41);
  static const darkPrimaryContainer = Color(0xFF1E4DCC);
  static const darkOnPrimaryContainer = Color(0xFFDBE7FF);

  // Secondary: Vibrant Purple
  static const darkSecondary = Color(0xFFA855F7);
